...
public class exportToolpath : MonoBehaviour
{
    ...
    public void exportToolPath()
    {
        ...
        var filePath = System.IO.Path.Combine(Application.persistentDataPath, "toolpath_csv.csv");
    ...
    private void generateGCode()
    {
        ...
        //export gcode
        var filePath = System.IO.Path.Combine(Application.persistentDataPath, "toolpath_gc.gcode");
